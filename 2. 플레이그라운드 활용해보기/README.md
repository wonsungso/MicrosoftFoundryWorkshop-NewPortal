...
![](./images/image_gpt4o_playground.png)
...
![](./images/image_gpt4o_playground_2.png)

## RAG +데이터 추가 구성

![](./images/image_rag_arch.png)
...
![](./images/image_aisearch_identity.png)
...
![](./images/image_blobstorage_creation.png)
...
![image.png](./images/image_project_connections.png)

5. `Azure AI Search`를 선택하고 `aisearch-<alias>`를 고른 뒤 인증 유형을 `Microsoft Entra ID`로 선택해 연결합니다.

![](./images/image_connection_aisearch.png)

![](./images/image_connection_aisearch_2.png)
...
![](./images/image_foundry_iq_index.png)

5. 다시 한번 `gpt-4o` 모델의 플레이그라운드에서 `도구` > `파일 업로드`를 다시 한번 클릭한 후 생성한 인덱스를 선택/연결 합니다.

![](./images/image_created_playground_index.png)
...
![](./images/image_playground_with_knowledge.png)
